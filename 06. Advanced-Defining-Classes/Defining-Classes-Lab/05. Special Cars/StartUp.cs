...
namespace CarManufacturer
{
    internal class StartUp
    {
        ...
        private static List<Car> GetListOfCars(List<Engine> engineList, List<Tire[]> tiresList)
        {
            ...
            while (carsInput != "Show special")
            {
                ...
                Engine engine = engineList[int.Parse(carData[5])];
        ...
        private static List<Engine> GetListOfEngines()
        {
            ...
            {
                var engineInfo = inputEngines.Split(' ');
